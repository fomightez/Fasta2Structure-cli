...
*tl;dr:*  
Click any `launch binder` badge on this page to get a session all set to step through running a Jupyter notebook demonstrating the script inside your browser with no installation needed. Or click [here](https://mybinder.org/v2/gh/fomightez/Fasta2Structure-cli/main?urlpath=%2Flab%2Ftree%2Findex.ipynb).
...
**The improved script that I've provided here also retains the ability to run the GUI way as well**, and therefore with the improved version you have much greater flexibility and it truly is much more convenient to a larger audience of users. (More [here](https://x.com/kmdouglass/status/1815659801784836503) and [here](https://x.com/kmdouglass/status/1815660982900822380) as to how scientists tend to overvalue GUIs and how a GUI framework can act as a barrier-to-entry for novices.)
